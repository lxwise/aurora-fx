...
/**
 * Windows 11 Fluent Design 主题完整组件演示
 * <p>
 * 展示所有 JavaFX 标准组件在 Windows 11 Light 主题下的外观效果。
 ...
 * @version 1.0
 */
public class Windows11ThemeDemo extends Application {

    @Override
    public void start(Stage stage) {
        // 设置 Windows 11 Light 主题
        ...
        stage.setTitle("Windows 11 Theme Demo — Fluent Design");
        stage.show();
    }
    ...
    private MenuBar createMenuBar() {
        ...
        // 查看菜单 - 含子菜单和 CheckMenuItem / RadioMenuItem
        Menu viewMenu = new Menu("查看(_V)");
        CheckMenuItem showToolbar = new CheckMenuItem("显示工具栏");
        showToolbar.setSelected(true);
        CheckMenuItem showStatusBar = new CheckMenuItem("显示状态栏");
        showStatusBar.setSelected(true);
        Menu zoomSubMenu = new Menu("缩放");
        ToggleGroup zoomGroup = new ToggleGroup();
        RadioMenuItem zoom100 = new RadioMenuItem("100%");
        zoom100.setToggleGroup(zoomGroup);
        zoom100.setSelected(true);
        RadioMenuItem zoom125 = new RadioMenuItem("125%");
        zoom125.setToggleGroup(zoomGroup);
        RadioMenuItem zoom150 = new RadioMenuItem("150%");
        zoom150.setToggleGroup(zoomGroup);
        zoomSubMenu.getItems().addAll(zoom100, zoom125, zoom150);
        viewMenu.getItems().addAll(showToolbar, showStatusBar, new SeparatorMenuItem(), zoomSubMenu);
    ...
    private HBox createHeader() {
        ...
        Label title = new Label("Windows 11 Fluent Design — 全组件演示");
        title.setStyle("-fx-font-size: 18px; -fx-font-weight: bold;");

        Region spacer = new Region();
        HBox.setHgrow(spacer, Priority.ALWAYS);

        Label badge = new Label("Windows11Light");
    ...
    private HBox createStatusBar() {
        ...
        bar.getChildren().addAll(
                ...
                new Label("主题: Windows 11 Light"),
                new Separator(Orientation.VERTICAL),
                new Label("Accent: #0078D4")
        );
        return bar;
    }
    ...
    private Tab createInputControlsTab() {
        ...
        ProgressBar pb5 = new ProgressBar(-1); // 不确定模式
        ...
        ListView<String> listView = new ListView<>(FXCollections.observableArrayList(
                "Windows 11 Light", "Windows 11 Dark", "macOS Light",
                "macOS Dark", "Primer Light", "Primer Dark",
                "Nord Light", "Nord Dark", "Dracula"));
        ...
        ColorPicker colorPicker = new ColorPicker(Color.web("#0078D4"));
    ...
    private Tab createContainerControlsTab() {
        ...
        stackDemo.setStyle("-fx-background-color: -color-bg-subtle; -fx-border-color: -color-border-default; -fx-border-radius: 4; -fx-background-radius: 4;");
        ...
        hboxDemo.setStyle("-fx-background-color: -color-accent-subtle; -fx-background-radius: 4;");
        for (int i = 1; i <= 4; i++) {
            Label l = new Label("HBox-" + i);
            l.setStyle("-fx-background-color: -color-bg-default; -fx-padding: 6 12; -fx-border-color: -color-border-default; -fx-border-radius: 4; -fx-background-radius: 4;");
            hboxDemo.getChildren().add(l);
        }
        VBox vboxDemo = new VBox(6);
        vboxDemo.setPadding(new Insets(8));
        vboxDemo.setStyle("-fx-background-color: -color-success-subtle; -fx-background-radius: 4;");
        for (int i = 1; i <= 3; i++) {
            Label l = new Label("VBox 项目 " + i);
            l.setStyle("-fx-background-color: -color-bg-default; -fx-padding: 4 12; -fx-border-color: -color-border-default; -fx-border-radius: 4; -fx-background-radius: 4;");
        ...
        bpDemo.setStyle("-fx-border-color: -color-border-default; -fx-border-radius: 4;");
        ...
        gridDemo.setStyle("-fx-background-color: -color-bg-subtle; -fx-background-radius: 4;");
        for (int r = 0; r < 3; r++) {
            for (int c = 0; c < 4; c++) {
                Label cell = new Label("(" + r + "," + c + ")");
                cell.setStyle("-fx-background-color: -color-bg-default; -fx-padding: 6 12; "
                        + "-fx-border-color: -color-border-muted; -fx-border-radius: 3; -fx-background-radius: 3;");
    ...
    private Tab createTableTreeTab() {
        ...
        TreeItem<String> treeRoot = new TreeItem<>("项目根目录");
    ...
    private Tab createDialogTab() {
        ...
        infoBtn.setOnAction(e -> {
            ...
            alert.setContentText("这是一个信息提示对话框，展示 Windows 11 主题效果。");
            alert.showAndWait();
        });
        ...
        choiceDialogBtn.setOnAction(e -> {
            ChoiceDialog<String> cd = new ChoiceDialog<>("Java", "Java", "Python", "Kotlin", "Go", "Rust");
            cd.setTitle("选择语言");
        ...
        // --- FileChooser / DirectoryChooser (说明) ---
        ...
        openFileBtn.setOnAction(e -> {
            ...
            fc.getExtensionFilters().addAll(
                    ...
                    new javafx.stage.FileChooser.ExtensionFilter("CSS 文件", "*.css")
            );
    ...
    private Tab createOtherControlsTab() {
        ...
        tipBtn2.setTooltip(new Tooltip("Windows 11 风格的 Tooltip"));
    ...
    private ObservableList<DemoItem> createDemoData() {
        return FXCollections.observableArrayList(
                new DemoItem("Windows11Light", "浅色主题", "活跃", "Windows 11 Fluent Design 浅色"),
                new DemoItem("Windows11Dark", "深色主题", "活跃", "Windows 11 Fluent Design 深色"),
                new DemoItem("MacOSLight", "浅色主题", "活跃", "macOS San Francisco 浅色"),
                new DemoItem("MacOSDark", "深色主题", "活跃", "macOS San Francisco 深色"),
                new DemoItem("PrimerLight", "浅色主题", "参考", "GitHub Primer 浅色"),
                new DemoItem("PrimerDark", "深色主题", "参考", "GitHub Primer 深色"),
                new DemoItem("NordLight", "浅色主题", "计划中", "Nord 极光浅色"),
                new DemoItem("NordDark", "深色主题", "计划中", "Nord 极光深色")
        );
    }
